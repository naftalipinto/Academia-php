...
$ress=mysqli_query($conectar,$sql2);
}
?>
<!DOCTYPE html>
<html lang="en">
        ...
        <main>
            ...
            <div class="tabs">
                ...
                <thead>
                    ...
                    <tbody>
                        <?php
                    while( $dados = mysqli_fetch_assoc($ress)){ 
                        echo"<tr>";
                        echo"<td>".$dados['nsala']."</td>";
                        echo"<td> <a href='sl_editar.php?id_sala=$dados[id_sala]'> <img src='../img/edit_25px.png'></a></td>";
                        echo"<td> <a href='fn/sl_delete.php?id_sala=$dados[id_sala]'><img src='../img/delete_25px.png'></a></td>";
                        echo"</tr>";
                }
                ?>
                    </tbody>
