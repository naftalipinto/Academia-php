...
$resp=mysqli_query($conectar,$sql2);

$sql3="select * from telefone_prof";
$rest=mysqli_query($conectar,$sql3);

$sql4="select * from proforienta";
        ...
        <main>
            ...
            <div class="tabs">
                ...
                <thead>
                    ...
                    <tbody>
                        <?php
                    while( $dados = mysqli_fetch_assoc($resp)){ 
                        echo"<tr>";
                        ...
                        echo"<td>".$dados['carteira']."</td>";
                        echo"<td> <a href='professor_editar.php?id_professor=$dados[id_professor]'> <img src='../img/edit_25px.png'></a></td>";
                        echo"<td> <a href='#'><img src='../img/delete_25px.png'></a></td>";
                        echo"</tr>";
                }
                ?>
                    </tbody>
